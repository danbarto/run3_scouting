...
def dR(A, B):
    dphi = min(abs(A.phi()-B.phi()), 2*math.pi - abs(A.phi()-B.phi()))
...
class Looper(object):
    ...
    def init_tree(self):
        ...
        print("Output Tree: " + str(self.outtree))
        cachesize = 30000000
    ...
    def init_branches(self):
        ...
        make_branch("GenMuon_mother_m", "vf")
    ...
    def run(self):
        ...
        for evt in ch:
            ...
            for genpart in genparts:
                ...
                if (motherid in [23, 6000211, 999999, 1999999, 3000022]) and (abs(pdgid)==13) or True: #Edit this for ultraslim
