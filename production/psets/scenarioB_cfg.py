...
# with command line options: Configuration/GenProduction/python/scenarioB.py --python_filename scenarioB_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:sample_scenB_gensim.root --conditions 124X_mcRun3_2022_realistic_v12 --beamspot Realistic25ns13p6TeVEarly2022Collision --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100) --step GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/scenarioB.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:sample_scenB_gensim.root'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '4900113:onMode = 0',
            '4900213:onMode = 0',
            '999999:all = GeneralResonance void 1 0 0 1.5 0.001 0. 0. 0.',
            '999999:addChannel = 1 0.269 91 11 -11',
            '999999:addChannel = 1 0.269 91 13 -13',
            '999999:addChannel = 1 0.0205 91 321 -321',
            '999999:addChannel = 1 0.016 91 211 -211 111',
            '999999:addChannel = 1 0.178 91 211 -211 211 -211',
            '999999:addChannel = 1 0.151 91 211 -211 111 111',
            '999999:tau0 = 5.85e-05',
            '4900221:addChannel = 1 0.097 91 999999 999999',
            '4900221:addChannel = 1 0.903 91 4900211 999999',
            '4900221:tau0 = 5.48e-09',
            '4900111:onMode = 0',
            '4900211:onMode = 0'
        ),
