...
# with command line options: Configuration/GenProduction/python/scenarioC.py --python_filename scenarioC.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:sample_scenC_gensim.root --conditions 124X_mcRun3_2022_realistic_v12 --beamspot Realistic25ns13p6TeVEarly2022Collision --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100) --step GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/scenarioC.py nevts:100'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '4900101:m0 = 4.543574755158214',
            '4900102:m0 = 4.666425244841786',
            '4900111:m0 = 2.2',
            '4900211:m0 = 2.2',
            '4900221:m0 = 5.0',
            '4900113:m0 = 4.0',
            ...
            '4900113:onMode = 0',
            '4900213:onMode = 0',
            '4900221:addChannel = 1 0.267 91 4900211 11 -114900221:addChannel = 1 0.155 91 4900211 211 -211',
            '4900221:addChannel = 1 0.0136 91 4900211 321 -321',
            '4900221:addChannel = 1 0.0186 91 4900211 211 -211 111',
            '4900221:addChannel = 1 0.0355 91 4900211 211 -211 211 -211',
            '4900221:addChannel = 1 0.0352 91 4900211 211 -211 111 111',
            '4900221:addChannel = 1 0.262 91 4900211 13 -13',
            '4900221:addChannel = 1 0.137 91 4900211 2 -2',
            '4900221:addChannel = 1 0.00774 91 4900211 4 -4',
            '4900221:addChannel = 1 0.0343 91 4900211 1 -1',
            '4900221:addChannel = 1 0.0343 91 4900211 3 -3',
            '4900221:tau0 = 18.3',
            '4900111:onMode = 0',
            '4900211:onMode = 0'
        ),
